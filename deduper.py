...
def printReport(gneralReport:bool, clonesReport:bool, totalFileCount:int, totalFileSize:int, bestVersSize:int, gameGroups:[],bestVers:[]):
...
def dedupFolder(args):
    ...
    printReport(args.general_report, args.clones_report,totalFileCount, totalFileSize, bestVersSize,bestVers)
...
def dedupGameList(args):
    ...
    printReport(True, True,  0, 0,0,gameGroups, bestVers)